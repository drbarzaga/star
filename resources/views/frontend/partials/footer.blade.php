<div id="footer-v6" class="footer-v6" style="font-size: 16px;">
    <div class="footer">
        <div class="container">
            <div class="row">
                <!-- About Us -->
                {{--<div class="col-md-3 sm-margin-bottom-40 wow slideInUp">--}}
                    ...
                    {{--<p style="text-transform: lowercase;">--}}
                        {{--SKY TECHNICS AVIATION REPAIRS SYNONYM OF PROFESSIONALISM, EFFICIENCY AND FIRST CLASS SERVICE. THOSE ARE OUR MAIN QUALITIES AND PRINCIPLES OF WHAT WE STAND FOR--}}
                    {{--</p>--}}
                {{--</div>--}}
            ...
            <div class="row">
                <div class="col-md-8 sm-margon-bottom-10">
                    <ul class="list-inline terms-menu">
                        <li class="silver">Copyright © {{ date('Y') }} <a href="{{ route('frontend.home') }}">STAR</a> - All Rights Reserved</li>
                    </ul>
                </div>
            </div>
        </div>
